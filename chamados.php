  ...
  <div class="modal fade modal-delete" tabindex="-1" role="dialog">
      <div class="modal-dialog" role="document">
          <div class="modal-content">
              ...
              <div class="modal-body">
                  <p>Deseja realmente excluir o servi&ccedil;o <span class="msg-serv"></span></p>
              </div>
              <div class="modal-footer">
                  <button type="button" class="btn btn-primary btn-sim">Sim</button>
                  <button type="button" class="btn btn-default" data-dismiss="modal">N&atilde;o</button>
              ...
              <div class="col-md-11">
                  <form class="formulario">
                      ...
                      <div class="form-group ">
                          ...
                          <div class="col-md-2">
                              <input type="text" class="form-control" id="cdos" placeholder="C&oacute;d" disabled value="<?php echo $_cdOs; ?>">
                          </div>
                      </div>
