...
$(document).ready( function () {
	...
	oTest.fnTest(
		...
		function () { $('#example_next').click(); },
		function () { return document.getElementById('example_info').innerHTML == "Mostrando 11 to 20 of 57 entries"; }
	);
	
	oTest.fnTest(
		"Information on third page",
		function () { $('#example_next').click(); },
		function () { return document.getElementById('example_info').innerHTML == "Mostrando 21 to 30 of 57 entries"; }
	);
	...
	oTest.fnTest(
		...
		function () { return document.getElementById('example_info').innerHTML == "Mostrando 51 to 57 of 57 entries"; }
	);
	...
	oTest.fnTest(
		...
		function () { $("select[name=example_length]").val('25').change(); },
		function () { return document.getElementById('example_info').innerHTML == "Mostrando 1 to 25 of 57 entries"; }
	);
	
	oTest.fnTest(
		"Information with 25 records - second page",
		function () { $('#example_next').click(); },
		function () { return document.getElementById('example_info').innerHTML == "Mostrando 26 to 50 of 57 entries"; }
	);
	...
	oTest.fnTest(
		...
		function () { return document.getElementById('example_info').innerHTML == "Mostrando 1 to 57 of 57 entries"; }
	);
