...
$(document).ready( function () {
	...
	oTest.fnWaitTest( 
		...
		function () { return $('#example_info').html() == "Mostrando 1 to 9 of 9 entries (filtered from 57 total entries)"; }
	);
	...
	oTest.fnWaitTest( 
		...
		function () { return $('#example_info').html() == "Mostrando 1 to 3 of 3 entries (filtered from 57 total entries)"; }
	);
