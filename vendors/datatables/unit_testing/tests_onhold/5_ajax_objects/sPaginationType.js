...
$(document).ready( function () {
	...
	oTest.fnWaitTest( 
		...
		function () {
			return document.getElementById('example_info').innerHTML == "Mostrando 51 to 57 of 57 entries";
		}
	);
	...
	oTest.fnWaitTest( 
		...
		function () {
			return document.getElementById('example_info').innerHTML == "Mostrando 31 to 40 of 57 entries";
		}
	);
	...
	oTest.fnWaitTest( 
		...
		function () {
			return document.getElementById('example_info').innerHTML == "Mostrando 41 to 50 of 57 entries";
		}
	);
	...
	oTest.fnWaitTest( 
		...
		function () {
			return document.getElementById('example_info').innerHTML == "Mostrando 1 to 10 of 57 entries";
		}
	);
