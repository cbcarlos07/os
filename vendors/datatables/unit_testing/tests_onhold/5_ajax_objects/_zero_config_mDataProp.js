...
$(document).ready( function () {
	...
	oTest.fnTest(
		...
		null,
		function () { return document.getElementById('example_info').innerHTML == "Mostrando 1 à 10 de 57 registros"; }
	);
	
	oTest.fnTest(
		"Information on second page",
		function () { $('#example_next').click(); },
		function () { return document.getElementById('example_info').innerHTML == "Mostrando 11 à 20 of 57 registros"; }
	);
	
	oTest.fnTest(
		"Information on third page",
		function () { $('#example_next').click(); },
		function () { return document.getElementById('example_info').innerHTML == "Mostrando 21 à 30 of 57 registros"; }
	);
	...
	oTest.fnTest(
		...
		function () { return document.getElementById('example_info').innerHTML == "Mostrando 51 à 57 of 57 registros"; }
	);
	...
	oTest.fnTest(
		...
		function () { return document.getElementById('example_info').innerHTML == "Mostrando 1 to 10 of 57 registros"; }
	);
	
	oTest.fnTest(
		"Information with 25 records",
		function () { $("select[name=example_length]").val('25').change(); },
		function () { return document.getElementById('example_info').innerHTML == "Mostrando 1 to 25 of 57 registros"; }
	);
	
	oTest.fnTest(
		"Information with 25 records - second page",
		function () { $('#example_next').click(); },
		function () { return document.getElementById('example_info').innerHTML == "Mostrando 26 to 50 of 57 registros"; }
	);
	...
	oTest.fnTest(
		...
		function () { return document.getElementById('example_info').innerHTML == "Mostrando 1 to 57 of 57 registros"; }
	);
	...
	oTest.fnTest(
		...
		function () { return document.getElementById('example_info').innerHTML == 
			"Mostrando 1 to 10 of 31 entries (filtered from 57 total entries)"; }
	);
	...
	oTest.fnTest(
		...
		function () { $('#example_next').click(); },
		function () { return document.getElementById('example_info').innerHTML == 
			"Mostrando 11 to 20 of 31 entries (filtered from 57 total entries)"; }
	);
	...
	oTest.fnTest(
		...
		function () { return document.getElementById('example_info').innerHTML == 
			"Mostrando 31 to 31 of 31 entries (filtered from 57 total entries)"; }
	);
	...
	oTest.fnTest(
		...
		function () { return document.getElementById('example_info').innerHTML == 
			"Mostrando 1 to 9 of 9 entries (filtered from 57 total entries)"; }
	);
	...
	oTest.fnTest(
		...
		function () { return document.getElementById('example_info').innerHTML == 
			"Mostrando 1 to 10 of 57 entries"; }
	);
	...
	oTest.fnTest(
		...
		null,
		function () { return document.getElementById('example_info').innerHTML == 
			"Mostrando 1 to 10 of 42 entries (filtered from 57 total entries)"; }
	);
	...
	oTest.fnTest(
		...
		function () { return document.getElementById('example_info').innerHTML == 
			"Mostrando 1 to 10 of 32 entries (filtered from 57 total entries)"; }
	);
	...
	oTest.fnTest(
		...
		null,
		function () { return document.getElementById('example_info').innerHTML == 
			"Mostrando 1 to 6 of 6 entries (filtered from 57 total entries)"; }
	);
	...
	oTest.fnTest(
		...
		null,
		function () { return document.getElementById('example_info').innerHTML == 
			"Mostrando 0 to 0 of 0 entries (filtered from 57 total entries)"; }
	);
	...
	oTest.fnTest(
		...
		function () { return document.getElementById('example_info').innerHTML == 
			"Mostrando 1 to 10 of 17 entries (filtered from 57 total entries)"; }
	);
